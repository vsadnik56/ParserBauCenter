...
namespace Parser
{
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                Console.WriteLine(">>>Введите артикуль товара!<<<");
            ...
            {
                Console.WriteLine("Товара с таким артикулем нет!");
            }
            catch (FormatException)
            {
                Console.WriteLine("Артикуль должен содержать только числительные!");
            }
